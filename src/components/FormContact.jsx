  ...
  return (
    <Reveal>
      <form
        ref={form}
        onSubmit={sendEmail}
        className="  max-w-xs mx-auto w-full pt-16"
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            value="Send"
            className="flex items-center justify-center h-10 gap-2 p-3 rounded-lg font-yatra btn-active mb-10 w-full bg-gradient custom-gradient-class text-white hover:scale-95 duration-200"
          >
            <FontAwesomeIcon
              className="mb-0.5"
              icon={faEnvelope}
