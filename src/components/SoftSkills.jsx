...
import { sliderSettings, useIsDesktop } from "./SliderSettings";
...
function SoftSkills() {
  ...
  return (
    <>
      <InView triggerOnce>
        {({ inView, ref }) => (
          <section className="md:grid md:grid-cols-3 md:mx-16  place-items-center">
            {isDesktop ? (
              softSkillsData.map((softSkill, index) => (
                <motion.div
                  ...
                  ref={ref}
                  key={index}
                  className="items-center shadow-md w-[200px] h-[220px] shadow-blue-800 mb-10 ml-2 rounded-xl"
                >
              ...
              <Slider {...sliderSettings}>
                {softSkillsData.map((softSkill) => (
                  <motion.div className="items-center shadow-md w-[200px] h-[220px] shadow-blue-800 mb-10 ml-2 rounded-xl">
                    <h1 className="text-center pt-5 font-bold font-yatra custom-gradient-text">
                      {softSkill.name}
                    </h1>
